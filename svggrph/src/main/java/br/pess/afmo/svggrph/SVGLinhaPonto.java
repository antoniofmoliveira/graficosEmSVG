/* $Id: SVGLinhaPonto.java 18 2006-09-14 17:11:42Z antoniofmoliveira@outlook.com $ */
 ...
 */
public class SVGLinhaPonto extends GraficoSVGAbstrato {
...
/**
    ...
    public Document getSVGDocument() throws UnsupportedEncodingException, TranscoderException {
        ...
        for (int i = 0; i < seriesLinha.length; i++) {
            ...
            etext.appendChild(text("text", "x:22;y:" + (255 + (10 * (i + fimAnt))), "font-size:6px;text-anchor:start;",
                    seriesNamesLinha[i]));
        ...
        Element t = text("text",
                ...
                ((size * .7) + (((seriesColuna.length * 2) > 8) ? ((((seriesColuna.length * 2) - 8) * 7) + 20) : 0)), //(((size * .7)+(seriesColuna.length*2>8?((seriesColuna.length*2-8)*20):0))),
        ...
        if (observacoes.length > 0) {
            t = text("text",
                    ...
                    (((size * .7) + (((seriesColuna.length * 2) > 8) ? ((((seriesColuna.length * 2) - 8) * 7) + 20) : 0)) -
    ...
    protected Element prepare() {
        ...
        setAttributes(svgRoot,
            ...
            ((largura * .7) + (((seriesColuna.length * 2) > 8) ? ((((seriesColuna.length * 2) - 8) * 20) + 20) : 0)));
